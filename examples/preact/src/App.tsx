...
import { InvokeError } from "@dammers/use-signalr-preact";
...
export function App() {
  return (
    <SignalRProvider baseUrl={BASE_URL} accessTokenFactory={makeToken("preact")}>
      <Main />
    </SignalRProvider>
  );
}
