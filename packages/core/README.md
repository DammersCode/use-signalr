...
| `createInvoker(deps, hub, method, getOptions, onAbort)`                                                          | Builds the request/response call function behind an invoke hook: waits for connection, retries idempotent failures, rethrows business errors.                            |
